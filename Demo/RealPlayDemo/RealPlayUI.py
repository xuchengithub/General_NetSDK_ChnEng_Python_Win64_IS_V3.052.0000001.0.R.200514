...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.IP_lineEdit.setGeometry(QtCore.QRect(90, 380, 91, 20))
        ...
        self.Port_lineEdit.setGeometry(QtCore.QRect(260, 380, 51, 20))
        ...
        self.Name_lineEdit.setGeometry(QtCore.QRect(90, 420, 91, 20))
        ...
        self.Pwd_lineEdit.setGeometry(QtCore.QRect(260, 420, 91, 20))
        ...
        self.play_btn.setGeometry(QtCore.QRect(260, 450, 91, 31))
        self.play_btn.setObjectName("play_btn")
        self.StreamTyp_comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.StreamTyp_comboBox.setEnabled(False)
        self.StreamTyp_comboBox.setGeometry(QtCore.QRect(90, 460, 141, 22))
